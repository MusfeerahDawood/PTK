...
namespace PTK.Controllers
{
    public class ChefsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Image,Nationaliy")] Chef chef)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Image,Nationaliy")] Chef chef)
        {
            if (id != chef.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> Delete(int? id)
        {
            ...
            List<ChefofPizza> chefofPizzas = await _context.ChefofPizza.Where<ChefofPizza>(a => a.ChefId == chef.Id).ToListAsync();
            List<Pizza> pizzas = await _context.Pizza.ToListAsync();


            ViewData["pizzas"] = pizzas;
            ViewData["chefofPizzas"] = chefofPizzas;
